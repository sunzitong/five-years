...
let timer;
const { $ } = window;
const jqSend = $('.iqiyi-send');
const jqInput = $('.iqiyi-input-code');
const jqRecive = $('.iqiyi-recive');
const jqInfo = $('.info');
const jqSure = $('.sure');
const jqModal = $('.iqiyi-modal');
const jqModalCover = $('.modal-cover');
const jqTel = $('.iqiyi-tel');
...
function reciveCoupon() {
  ...
  const codeNumber = tool.createCode('iqiyi');
  const value = {
    activityNumber: 202003104436, // 活动编码
    channel: 'iqiyi', //  渠道
